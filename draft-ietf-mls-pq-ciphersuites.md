...
As {{!I-D.ietf-hpke-pq}} does not define either function for "single-stage" KDFs like SHAKE (see {{Section 5 of !I-D.ietf-hpke-pq}}), the cipher suites defined here use SHA-384 and SHA-256 for the KDF functions used inside MLS.
